...
if ($firstName == '' || $lastName == '') {
    ...
    $firstName = mb_substr($billingLastName, 1, mb_strlen($billingLastName, 'UTF-8') - 1, 'UTF-8');
    $lastName = mb_substr($billingLastName, 0, 1, 'UTF-8');
}
...
<form class="woocommerce-EditAccountForm edit-account" action="" method="post">
    ...
    <p class="woocommerce-FormRow woocommerce-FormRow--first form-row form-row-first" style="display: none;">
        ...
        <input type="text" class="woocommerce-Input woocommerce-Input--text input-text" name="account_first_name" id="account_first_name" value="<?php echo esc_attr( $firstName ); ?>" />
    </p>
    <p class="woocommerce-FormRow woocommerce-FormRow--last form-row form-row-last" style="display: none;">
        <label for="account_last_name"><?php _e( 'Last name', 'woocommerce' ); ?> <span class="required">*</span></label>
        <input type="text" class="woocommerce-Input woocommerce-Input--text input-text" name="account_last_name" id="account_last_name" value="<?php echo esc_attr( $lastName ); ?>" />
    </p>
    <div class="clear"></div>

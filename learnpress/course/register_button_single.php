...
<div class="cmsmasters_course_meta_item text-align-center">
	<a href="<?php echo esc_url(site_url('register-for-courses?title=' . urlencode(get_the_title()) . '&price=' . urlencode(learn_press_get_course_price( null, true )) . '&course_id=' . urlencode(get_the_ID()) )); ?>"

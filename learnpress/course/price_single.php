...
<div class="cmsmasters_course_meta_item">
	...
	<div class="cmsmasters_course_meta_info">
		<span class="course-price">
			...
			<span class="line-through float-right">₩ <?php echo number_format(get_post_meta( get_the_ID(), '_lpr_course_duration', true )); ?></span>
			<br/> → <?php echo learn_press_get_course_price( null, true );?>
